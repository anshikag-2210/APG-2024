            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Fourth Row
                  buildIconRow(context, [
                    IconButtonData(icon: Icons.school, label: "CE Courses", view: Home()),
...
// Dummy view classes for navigation
class BrochureView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text('Brochure')));
  }
}

// Create other views similarly for TracksView, ScheduleView, FavouritesView, etc.
...
// Add similar classes for other views like KeynoteSpeakersView, ConferenceView, etc.
